...
class ModuleController extends Controller {
    public function showModule($courseName, $moduleNumber, $encryptedModuleId) {
        try {
            ...
            return view('components.job.module', compact('module', 'paid_course', 'videos', 'resources', 'assignments'));
        } catch (Exception $e) {
            return redirect()->back();
        }
    }

    public function assignMarks(Request $request, $assignment_id) {
        $request->validate([
    ...
    public function updateModuleTopics(Request $request, $module_id) {
        $module = Module::findOrFail($module_id);
        $module->covered_topics = $request->input('covered_topics');
        $module->save();
    ...
    public function updateAssignmentTopics(Request $request, $module_id) {
        $module = Module::findOrFail($module_id);
        $module->assignment_topics = $request->input('assignment_topics');
        $module->save();

        return redirect()->back()->with('success', 'Assignment topics updated successfully');
    }
